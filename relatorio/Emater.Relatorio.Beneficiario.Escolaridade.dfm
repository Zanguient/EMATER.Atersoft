inherited FrmRelatorioBeneficiarioEscolaridade: TFrmRelatorioBeneficiarioEscolaridade
  Left = 404
  Top = 165
      ...
      inherited GrpBxOpcoes: TcxGroupBox
        ...
        inherited CmbBxCampo: TcxComboBox
          Properties.Items.Strings = (
            'Descri'#231#227'o da escolaridade')
          Text = 'Descri'#231#227'o da escolaridade'
        end
      end
    end
  end
  ...
  inherited FrxPrincipal: TfrxReport
    ...
    ReportOptions.LastChange = 42526.868324918980000000
    ScriptText.Strings = (
      'begin'
      '    '
      'end.')
      ...
      inherited Header: TfrxHeader
        ...
        inherited MemoTitulo: TfrxMemoView
          ...
          Memo.UTF8W = (
            ...
            'integrantes familiares, segundo a escolaridade')
        end
  ...
  object QryPrincipal: TFDQuery
    ...
    SQL.Strings = (
      'select id, escolaridade, beneficiarios, integrantes, total'
      'from stp_rel_escolaridade_01 (:data_inicio, :data_fim, :unidade)'
