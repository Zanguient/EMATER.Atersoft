inherited FrmCadastroUnidadeAtividade: TFrmCadastroUnidadeAtividade
  ...
  object LblTitulo: TLabel [0]
    ...
    Align = alTop
    AutoSize = False
    Caption = '      Descri'#231#227'o da atividade produtiva'
    Color = 4551200
    ...
    inherited TbShtPrincipal: TcxTabSheet
      ...
      object GrpBxAtividades: TcxGroupBox
        ...
        object LblAreaPlantada: TLabel
          ...
          FocusControl = DbEdtAreaPlantada
          Transparent = True
        end
      ...
      object GrpBxRegistro: TcxGroupBox
        ...
        object DbLkpCmbBxTecnico: TcxDBLookupComboBox
          ...
          DataBinding.DataSource = FrmCadastroUnidade.DtSrcProducaoAtividade
          Properties.DropDownRows = 16
          Properties.ImmediatePost = True
  ...
  object DtSrcProducaoAtividade: TDataSource
    DataSet = FrmCadastroUnidade.QryProducaoAtividade
    Left = 288
    Top = 39
  end
  object DtSrcProduto: TDataSource
    DataSet = FrmCadastroUnidade.QryProduto
    Left = 288
    Top = 72
  end
end
