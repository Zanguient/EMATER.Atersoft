unit Emater.Relatorio.Beneficiario.Ribeirinho;
...
type
  TFrmRelatorioBeneficiarioRibeirinho = class(TFrmBaseRelatorio)
...
var
  FrmRelatorioBeneficiarioRibeirinho: TFrmRelatorioBeneficiarioRibeirinho;
...
procedure TFrmRelatorioBeneficiarioRibeirinho.BtnImprimirClick(Sender: TObject);
begin
...
procedure TFrmRelatorioBeneficiarioRibeirinho.BtnLimparClick(Sender: TObject);
begin
...
procedure TFrmRelatorioBeneficiarioRibeirinho.FormCreate(Sender: TObject);
begin
  inherited;
  FrmFiltro.EdtDataInicio.Date := EncodeDate(YearOf(Date), MonthOf(Date), 1);
  FrmFiltro.EdtDataFim.Date := EncodeDate(YearOf(Date), MonthOf(Date), DaysInMonth(Date));
...
procedure TFrmRelatorioBeneficiarioRibeirinho.FormShow(Sender: TObject);
begin
  inherited;
  FrmFiltro.LkpCmbBxUnidade.EditValue := DtmSistemaModulo.UnidadeLocalID;
end;

procedure TFrmRelatorioBeneficiarioRibeirinho.FrxPrincipalGetValue(const VarName: string; var Value: Variant);
var
