inherited FrmSistemaPermissao: TFrmSistemaPermissao
  ...
  Caption = 'Sistema :: Usu'#225'rios :: Permiss'#245'es'
  ClientHeight = 441
  ClientWidth = 650
  ...
  object BarManager: TdxBarManager
    ...
    object BtnPerfis: TdxBarButton
      ...
      Category = 0
      Description = 'Acessar tabela de perfis de usu'#225'rios.'
      Hint = '01. Perfis'
      Visible = ivAlways
      ImageIndex = 151
    ...
    object BtnUsuarios: TdxBarButton
      ...
      Category = 0
      Description = 'Acessar tabela de usu'#225'rios.'
      Hint = '02. Usu'#225'rios'
      Visible = ivAlways
      ImageIndex = 149
