inherited FrmRelatorioBeneficiarioGenero: TFrmRelatorioBeneficiarioGenero
  Left = 517
  Top = 152
  ...
  inherited FrxPrincipal: TfrxReport
    ...
    ReportOptions.LastChange = 42527.477509513890000000
    ScriptText.Strings = (
      'begin'
      '    '
      'end.')
    ...
    inherited Page1: TfrxReportPage
      ...
      inherited Header: TfrxHeader
        ...
        inherited MemoTitulo: TfrxMemoView
          ...
          Memo.UTF8W = (
            'Quantidade de benefici'#225'rios de ATER cadastrados'
  ...
  object QryPrincipal: TFDQuery
    ...
    SQL.Strings = (
        ...
        'select * from stp_rel_categoria_04 (:data_inicio, :data_fim, :un' +
        'idade)'
      'order by id')
    Left = 112
    Top = 328
