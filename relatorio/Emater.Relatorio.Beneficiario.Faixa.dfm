inherited FrmRelatorioBeneficiarioFaixa: TFrmRelatorioBeneficiarioFaixa
  Left = 404
  Top = 165
      ...
      inherited GrpBxOpcoes: TcxGroupBox
        ...
        inherited CmbBxCampo: TcxComboBox
          Properties.Items.Strings = (
            'Descri'#231#227'o da faixa et'#225'ria')
          Text = 'Descri'#231#227'o da faixa et'#225'ria'
        end
      end
    end
  end
  ...
  inherited FrxPrincipal: TfrxReport
    ...
    ReportOptions.LastChange = 42526.924871516200000000
    ScriptText.Strings = (
      'begin'
      '    '
      'end.')
      ...
      inherited Header: TfrxHeader
        ...
        inherited MemoTitulo: TfrxMemoView
          ...
          Memo.UTF8W = (
            ...
            'integrantes familiares, segundo a faixa et'#225'ria')
        end
  ...
  object QryPrincipal: TFDQuery
    ...
    SQL.Strings = (
      'select *'
      'from stp_rel_faixa_etaria_01 (:data_inicio, :data_fim, :unidade)'
      'order by id')
    Left = 112
    Top = 328
    ParamData = <
