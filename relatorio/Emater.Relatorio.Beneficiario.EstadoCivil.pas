unit Emater.Relatorio.Beneficiario.EstadoCivil;
...
type
  TFrmRelatorioBeneficiarioEstadoCivil = class(TFrmBaseRelatorio)
...
var
  FrmRelatorioBeneficiarioEstadoCivil: TFrmRelatorioBeneficiarioEstadoCivil;
...
procedure TFrmRelatorioBeneficiarioEstadoCivil.BtnImprimirClick(Sender: TObject);
begin
...
procedure TFrmRelatorioBeneficiarioEstadoCivil.BtnLimparClick(Sender: TObject);
begin
...
procedure TFrmRelatorioBeneficiarioEstadoCivil.FormCreate(Sender: TObject);
begin
  inherited;
  FrmFiltro.EdtDataInicio.Date := EncodeDate(YearOf(Date), MonthOf(Date), 1);
  FrmFiltro.EdtDataFim.Date := EncodeDate(YearOf(Date), MonthOf(Date), DaysInMonth(Date));
...
procedure TFrmRelatorioBeneficiarioEstadoCivil.FormShow(Sender: TObject);
begin
  inherited;
  FrmFiltro.LkpCmbBxUnidade.EditValue := DtmSistemaModulo.UnidadeLocalID;
end;

procedure TFrmRelatorioBeneficiarioEstadoCivil.FrxPrincipalGetValue(const VarName: string; var Value: Variant);
var
